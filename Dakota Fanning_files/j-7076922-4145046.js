//Generated:2022-12-22 15:04:01// 39-536
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
    ...
    getBackup: function(div) {
      ...
      o.altimghref = o.convertUrlProtocol(o.altimghref.replace(";211;", ";210;"));
  ...
  var data = {
    params: window.ftParams_7076922 || '',
    GUID: window.ftGUID_7076922 || '99999999999',
    confID: window.ftConfID_7076922 || '0',
    ftReturn: window.ftReturn_7076922 || '',
    keyword: window.ftKeyword_7076922 || '',
    ftId: window.ftId_7076922 || '',
    imp: window.ftImp7076922,
    ftImpId: window.ftImp7076922 && window.ftImp7076922.impID || '',
    gdpr: window.ftImp7076922 && window.ftImp7076922.gdpr || '',
    gdpr_consent: window.ftImp7076922 && window.ftImp7076922.gdpr_consent || '',
    gdpr_pd: window.ftImp7076922 && window.ftImp7076922.gdpr_pd || '',
    us_privacy: window.ftImp7076922 && window.ftImp7076922.us_privacy || '',
    campaignID: '199311',
    cID: '173053',
    pID: '7076922',
    creativeID: '4145046',
    exttrack: [
      'https://ad.doubleclick.net/ddm/trackimp/N424004.160337AMAZON.COM/B29088161.354911018;dc_trk_aid=546452151;dc_trk_cid=183713183;u=[FlashtalkingMacroKeyValue];kw=[url_encoded_publisher_data];ord=[timestamp];dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;gdpr=[%FT_GDPR%];gdpr_consent=[%FT_GDPR_CONSENT%];ltd=?[noCachebuster]'
    ],
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=607671&cmp=199311&sid=9988&plc=7076922&num=&adid=&advid=&adsrv=29&btreg=7076922&btadsrv=flashtalking&crt=4145046&gdpr=[%FT_GDPR%]&gdpr_consent=[%FT_GDPR_CONSENT%]&dvtagver=6.1.src&auevent=[ftqs:[ft_custom]],[ftqs:[ft_dv]];[noCachebuster]"
    ],
    clickTags: [
      "https://servedby.flashtalking.com/click/8/199311;7076922;4145046;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=320&ft_height=50&url=https://d.agkn.com/pixel/4069/?che=[FT_Random]&aid=19534&cvid=[FT_CONFID]&col=199311,9988,7076922,0,4145046,[%FT_IMPRESSIONID%],[%IDFA%]&l0=https://ad.doubleclick.net/ddm/trackclk/N424004.160337AMAZON.COM/B29088161.354911018;dc_trk_aid=546452151;dc_trk_cid=183713183;u=[FlashtalkingMacroKeyValue];kw=[url_encoded_publisher_data];dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;ltd=?https://www.att.com/"
    ],
    placementDescription: 'IAIBFGP006AMAZONAMZNMEDGPFIBDISCRSUFTRFGMALLINFUSANA320x50OOCUPRNAAmazonNewGreen0208NAFlashTalkingCPM',
    width: 320,
    height: 50,
    ...
    divID: 'ftdiv7076922',
    phID: 'ftpos7076922',
    frameID: 'ftframe7076922',
    expID: 'ftexpframe7076922',
    altImgID: 'ftalt7076922',
    altText: 'Click here',
    altImgTarget: '_blank',
    altimghref: 'https://servedby.flashtalking.com/click/8/199311;7076922;4145046;210;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=320&ft_height=50&url=https://d.agkn.com/pixel/4069/?che=[FT_Random]&aid=19534&cvid=[FT_CONFID]&col=199311,9988,7076922,0,4145046,[%FT_IMPRESSIONID%],[%IDFA%]&l0=https://ad.doubleclick.net/ddm/trackclk/N424004.160337AMAZON.COM/B29088161.354911018;dc_trk_aid=546452151;dc_trk_cid=183713183;u=[FlashtalkingMacroKeyValue];kw=[url_encoded_publisher_data];dc_lat=;dc_rdid=;tag_for_child_directed_treatment=;tfua=;ltd=?https://www.att.com/',
    altImg: 'https://servedby.flashtalking.com/imp/8/199311;7076922;204;gif;AmazonUS;IAIBFGP006AMAZONAMZNMEDGPFIBDISCRSUFTRFGMALLINFUSANA320x50OOCUPRNAAmazonNewGreen0208NAFlashTalkingCPM/?',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/199311;7076922;271;pixel;AmazonUS;IAIBFGP006AMAZONAMZNMEDGPFIBDISCRSUFTRFGMALLINFUSANA320x50OOCUPRNAAmazonNewGreen0208NAFlashTalkingCPM/?',
    stump: 'https://servedby.flashtalking.com',
    jsurl: 'http://cdn.flashtalking.com/xre/707/7076922/4145046/js/j-7076922-4145046.js',
    file: 'http://cdn.flashtalking.com/173053/4145046/index.html',
    safeFrame: window.$sf && window.$sf.ext || false,
    serveDOM: 'http://cdn.flashtalking.com',
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?225143861-7076922;4145046;',
    adVis: false ? 1 : 0,
    centreAd: false,
    mvt: true,
    segment: window.ftSegment_7076922 || '',
    segmentList: window.ftSegmentList_7076922 || [],
    ...
    baggyFrameLimit: 15,
    append: !!(window.ftImp7076922 && window.ftImp7076922.jsAppend),
    mayExpand: +'0' > 50 || +'0' > 320,
    noBreakout: false,
    ...
    pageVisible: 'maybe',
    altimgborder: '0',
    secure: !!(location.protocol === 'https:' || !!(document.getElementById('ftscript_m7076922') && /^https:/.test(document.getElementById('ftscript_m7076922').src)) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m7076922'),
    ...
    qsVars: [
      ['ftguid', 'ftGUID_7076922'],
      ['ftcfid', 'ftConfID_7076922'],
      ['fttime', 'ftTimestamp_7076922'],
      ['ftsection', 'ftSection_7076922'],
      ['ftcustom', 'ftCustom_7076922'],
      ['ft_id', 'ftId_7076922'],
      ['ftimpid', 'ftImp7076922', 'impID'],
      ['gdpr', 'ftImp7076922', 'gdpr'],
      ['gdpr_consent', 'ftImp7076922', 'gdpr_consent'],
      ['gdpr_pd', 'ftImp7076922', 'gdpr_pd'],
      ['us_privacy', 'ftImp7076922', 'us_privacy']
    ]
  };
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_7076922;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_7076922;
...
(function(o) {
  ...
  o.replaceMacros = function(str, cb) {
    var dcmU, dcmKW, auctionID, valueToExtract="";
    valueToExtract = encodeURIComponent(window['ftCustom_' + '7076922']);
    dcmU = encodeURIComponent(window['ftCustom_' + '7076922']);
    // dcmU = dcmU.slice(0,dcmU.lastIndexOf("_"));
    if(o.siteName == "XandrUS" || o.siteName == "DV360") {
        auctionID = valueToExtract.substr(12,valueToExtract.indexOf("PA___")-12);
    }
    else {
     auctionID = "";
   }
      try {
        if (dcmU.indexOf("AP1_me_dv") > -1) {
            dcmKW = dcmU.split("_dv_")[1].replace("PA___","_");
        } else if (dcmU.indexOf("AP1_np_dv") > -1) {
            dcmU = encodeURIComponent(window['ftCustom_' + '7076922']);
        } else if (/AP1_an_d|AP1_az_d/.test(dcmU)) {
            dcmKW = dcmU.split("___")[1];
        } else if (/AP1_db_dv_/.test(dcmU)) {
            dcmKW = dcmU.split("___")[1];
        }
      } catch(e) {};
      var map = {
        URL_ENCODED_PUBLISHER_DATA: dcmKW,
        FLASHTALKINGMACROKEYVALUE: dcmU,
        AUCTIONID: window['ftCustom_' + '7076922'],
        XANDRAUCTIONID : auctionID,
        DV360AUCTIONID : auctionID
      };
